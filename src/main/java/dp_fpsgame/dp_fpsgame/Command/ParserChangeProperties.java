...
public class ParserChangeProperties implements CmdParser {

    private final boolean isSuccess;//パース成功したかどうか
    public final String PropertiesName;
    public final String Value;//値

    private ParserChangeProperties(boolean isSuccess, String propertiesName, String value) {
    ...
    public static ParserChangeProperties parse(CommandSender sender, String[] args) {
        ...
        for (String prop : Props){
            ...
            if (argsList.contains(name)) {
                ...
                if (index + 1 >= argsList.size()) {
                    ...
                    return new ParserChangeProperties(false, null, null);
                }
                try {
                    // チーム
                ...
                return new ParserChangeProperties(true, prop, value);
            }
        }
        return new ParserChangeProperties(false, null, null);
    }
